...
function clickcarrosel(e) {
    ...
    //var miniAtual;
    var mini = e.src + "";
    mini.replace("http://127.0.0.1:5500/img/", "");    
    console.log(mini);    
    //var tituloAnt = ;
    ...
    filmesp.style.background = 'linear-gradient(rgba(0, 0, 0, .50), rgba(0, 0, 0, .50)100%), url(img/capa_sobrenatural.jpg)';
    filmesp.style.backgroundSize= 'cover';
    tituloP.innerHTML = "SOBRENATURAL";
    descricaoP.innerHTML = "Os irmãos Dean e Sam vasculham o país em busca de atividades paranormais, brigando com demônios, fantasmas e monstros no caminho.";
    e.src = "img/mini_davincis.jpg"
}
